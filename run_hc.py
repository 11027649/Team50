...
def main():
    ...
    with open('B1_3D_HC.csv', 'a', newline='') as datafile:
    ...
    # run 50 simulated annealing for protein C1
    with open('B2_3D_HC.csv', 'a', newline='') as datafile:
        datawriter = csv.writer(datafile)
    ...
    # run 50 simulated annealing for protein C1
    with open('B3_3D_HC.csv', 'a', newline='') as datafile:
        datawriter = csv.writer(datafile)
    ...
    # run 50 simulated annealing for protein C1
    with open('B4_3D_HC.csv', 'a', newline='') as datafile:
        datawriter = csv.writer(datafile)
