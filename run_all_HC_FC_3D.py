...
# import algorithms
from algorithms.HC_FC import hillclimber3D

import csv

def main():

    with open('B2_3D_HC_FC.csv', 'a', newline='') as datafile:
        ...
        for i in range(50):
            ...
            protein.init_grid()
            protein = hillclimber3D(protein)          
            datawriter.writerow([i] + [protein.winning_score])

    with open('B3_3D_HC_FC.csv', 'a', newline='') as datafile:
        datawriter = csv.writer(datafile)
    ...
    with open('B4_3D_HC_FC.csv', 'a', newline='') as datafile:
        datawriter = csv.writer(datafile)
    ...
    with open('C2_3D_HC_FC.csv', 'a', newline='') as datafile:
        datawriter = csv.writer(datafile)
    ...
    with open('C3_3D_HC_FC.csv', 'a', newline='') as datafile:
        datawriter = csv.writer(datafile)
    ...
    with open('C4_3D_HC_FC.csv', 'a', newline='') as datafile:
        datawriter = csv.writer(datafile)
